...
public class MiniPetSpeechAI : MonoBehaviour{
	public void ShowTipMsg(){
		...
		msgOption.Add(PetSpeechManager.Keys.MessageText, System.String.Format(Localization.Localize("MINIPET_RETENTION_TIP_"+ rand.ToString()), DataManager.Instance.GameData.PetInfo.PetName));
