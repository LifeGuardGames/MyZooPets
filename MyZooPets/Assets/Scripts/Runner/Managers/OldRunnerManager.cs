...
public class OldRunnerManager : MinigameManager<OldRunnerManager>{
	...
	protected override void _NewGame(){	
		...
		if(IsTutorialOn() && (IsTutorialOverride() || 
			!DataManager.Instance.GameData.Tutorial.IsTutorialFinished(OldRunnerTutorial.TUT_KEY))){
	...
	private void StartTutorial(){
		SetTutorial(new OldRunnerTutorial());
	}
}
