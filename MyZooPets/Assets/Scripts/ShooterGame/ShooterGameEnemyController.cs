...
public class ShooterGameEnemyController : Singleton<ShooterGameEnemyController>{
	...
	public List<ImmutableDataTriggerArmy> enemyList;		// list of the various enemy types
	...
	public void BuildEnemyList(){
		enemyList = DataLoaderTriggerArmy.GetDataList();	// TODO make sure this is sorted properly
	...
	public void SpawnWave(Wave currWave){
		...
		List<ImmutableDataTriggerArmy> WaveEnemies;
		WaveEnemies = new List<ImmutableDataTriggerArmy>();
		...
		ShooterSpawnManager.Instance.spawningList = WaveEnemies;
		ShooterSpawnManager.Instance.SpawnTriggers();
	}
